...
training_group.add_argument('--max_episode', type=int, default=10000)
...
training_group.add_argument('--load_aug_n', type=int, default=9)
training_group.add_argument('--load_aug_d4', action='store_true')
...
if env == 'block_stacking':
    ...
    args.num_objects = 6
    args.max_episode_steps = 30
elif env == 'box_palletizing':
    args.num_objects = 18
    args.max_episode_steps = 40
...
if args.load_buffer is None:
    args.load_buffer = 'outputs/buffer/{}/checkpoint/buffer.pt'.format(env)
load_buffer = args.load_buffer
load_n = args.load_n
load_aug_n = args.load_aug_n
load_aug_d4 = args.load_aug_d4
