...
class Margin6DASR5LDeictic(DQN6DASR5LDeictic, Margin6DASR5L):
    def __init__(self, workspace, heightmap_size, device, lr=1e-4, gamma=0.9, sl=False, num_primitives=1,
        ...
        DQN6DASR5LDeictic.__init__(self, workspace, heightmap_size, device, lr, gamma, sl, num_primitives, patch_size,
